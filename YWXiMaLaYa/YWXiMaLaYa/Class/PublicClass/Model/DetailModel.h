 ...
 *  最终目的地,选集列表
 */
@class Album,Tracks,Tracks_List;
...
@interface Tracks : BaseModel

@property (nonatomic, assign) NSInteger maxPageId;

@property (nonatomic, strong) NSArray<Tracks_List *> *list;
...
@interface Tracks_List : BaseModel
