...
// *  最终目的地,选集列表
// */
//@class YAlbum,YTracks,YTracks_List;
//
@interface DetailModel : BaseModel
//
//@property (nonatomic, strong) YTracks *tracks;
//
//@property (nonatomic, strong) YAlbum *album;
//
...
//@end
//
//@interface YTracks : BaseModel
//
//@property (nonatomic, assign) NSInteger maxPageId;
//
//@property (nonatomic, strong) NSArray<YTracks_List *> *list;
//
...
//@end
//
//@interface YTracks_List : BaseModel
//
//@property (nonatomic, assign) NSInteger status;
//
//@property (nonatomic, copy) NSString *title;
