...
@interface YWResourceLoader()

@property (nonatomic, strong) NSMutableArray * requestList;
@property (nonatomic, strong) YWRequestTask * requestTask;

@end

@implementation YWResourceLoader
...
#pragma mark - YWRequestTaskDelegate
...
- (void)newTaskWithLoadingRequest:(AVAssetResourceLoadingRequest *)loadingRequest cache:(BOOL)cache {
    ...
    self.requestTask = [[YWRequestTask alloc]init];
...
- (BOOL)finishLoadingWithLoadingRequest:(AVAssetResourceLoadingRequest *)loadingRequest {
    ...
    [loadingRequest.dataRequest respondWithData:[YWFileHandle readTempFileDataWithOffset:requestedOffset - self.requestTask.requestOffset length:respondLength]];
